...
const AnimatedSvg = () => (
  <svg className="BgAnimation__svg" viewBox="0 0 602 602" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      transform="rotate(45 294.685 193.474)"
    ...
    <path
      ...
      transform="rotate(-45 476.171 362.952)"
    ...
    <path
      ...
      transform="rotate(-45 381.81 154.669)"
    ...
    <ellipse
      ...
      rx="1.07306"
      ry="1.07433"
      transform="scale(-1 1) rotate(180 333.324 382.691)"
      fill="#F46737"
    >
    ...
    <path
      ...
      transform="scale(-1 1) rotate(45 333.667 382.335)"
    ...
    <path
      ...
      transform="rotate(45 165.182 94.3159)"
      stroke="url(#paint7_linear)"
    >
      <animateMotion dur="10s" begin="3s" repeatCount="indefinite" rotate="auto">
        <mpath href="#path_0" />
